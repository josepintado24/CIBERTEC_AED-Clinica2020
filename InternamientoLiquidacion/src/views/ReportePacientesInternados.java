...
public class ReportePacientesInternados extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReportePacientesInternados frame = new ReportePacientesInternados();
	 ...
	 * Create the frame.
	 */
	public ReportePacientesInternados() {
		...
		btnClose.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnClose.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/close-hover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnClose.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/close.png")));
			}
			@Override
		...
		cboBackground.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/contenedor-combo.png")));
		
		lblTitulo = new JLabel("Reporte de Pacientes Internados");
		...
		txtDesc.setText("En esta secci\u00F3n podras visualizar los registros de pacientes que se encuentran internados.");
		...
		ImageIcon background = new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/background-mantenimiento.png"));
		...
		arrowBuscarPor.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/ico-down.png")));
		...
		txtIngresar.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent arg0) {
				...
				if(cboSelect == 0){
					...
					if(cboSelect == 1){
						ArrayList<Internamiento> buscarInternado = internamiento.listInternadoCodigoInternamiento(term);
						if(buscarInternado != null){
							tabla.setRowCount(0);
							for(int i = 0; i < buscarInternado.size(); i++){
								Paciente getPaciente = paciente.buscarPorCodigo(buscarInternado.get(i).getCodPaciente());
								Object[] data = {
									buscarInternado.get(i).getCodInternamiento(),
									buscarInternado.get(i).getCodPaciente(),
									buscarInternado.get(i).getNombre(),
									getPaciente.getApellidos(),
									buscarInternado.get(i).getCodCama(),
									buscarInternado.get(i).getFechaIngreso(),
									buscarInternado.get(i).getHoraIngreso(),
									buscarInternado.get(i).getEstado()
								};
								tabla.addRow(data);
							}
						}
					...
					if(cboSelect == 2){
						ArrayList<Internamiento> buscarInternado = internamiento.listInternadoCodigoPaciente(term);
						if(buscarInternado != null){
							tabla.setRowCount(0);
							for(int i = 0; i < buscarInternado.size(); i++){
								Paciente getPaciente = paciente.buscarPorCodigo(buscarInternado.get(i).getCodPaciente());
					...
					if(cboSelect == 3){
						ArrayList<Internamiento> buscarInternado = internamiento.listInternadoCodigoCama(term);
						if(buscarInternado != null){
							tabla.setRowCount(0);
							for(int i = 0; i < buscarInternado.size(); i++){
								Paciente getPaciente = paciente.buscarPorCodigo(buscarInternado.get(i).getCodPaciente());
		...
		btnBuscar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBuscar.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/btn-login-hover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnBuscar.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/btn-login.png")));
			}
		...
		lblInputBuscar.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/text-buscar.png")));
		...
		lblInputIngresar.setEnabled(false);
		lblInputIngresar.setIcon(new ImageIcon(ReportePacientesInternados.class.getResource("/views/images/text-ingresar.png")));
	...
	private void listarPacientes(){
		...
		for(int i = 0; i < internamiento.tamanio(); i++){
			Paciente getPaciente = paciente.buscarPorCodigo(internamiento.obtener(i).getCodPaciente());
			Object[] data = {
